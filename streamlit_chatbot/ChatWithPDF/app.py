...
# Sales coach prompt
SALES_COACH_PROMPT = """
Act as an expert sales coach. Your job is to answer queries from sales agents to help them sell the Hyundai Creta only. Always answer from the context provided. Use the following 7-step framework to guide your responses:
...
Never recommend any other car other than the Hyundai Creta.
...
def get_conversation_chain(vectorstore, selected_model):
    ...
    return ConversationalRetrievalChain.from_llm(
        ...
        memory=memory,
        input_key="question",
        chain_type_kwargs={"prompt_template": SALES_COACH_PROMPT},
    )
